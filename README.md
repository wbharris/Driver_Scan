...
Simulate a Windows 11 PC from Linux (collector JSON, no Windows box required):
...
driver-scan list --fixture tests/data/windows11-dell.json --include-ignored --category graphics
```
